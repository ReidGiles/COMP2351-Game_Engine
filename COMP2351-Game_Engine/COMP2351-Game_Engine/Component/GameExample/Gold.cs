...
namespace COMP2351_Game_Engine
{
    class Gold : RelicHunterEntity, ICollisionListener
    {
        ...
        public override void SetCollider()
        {
            ...
            // Add collider to list
            _colliders.Add(new RectCollider(ColliderOrigin, texture.Width, texture.Height / 2, "GoldT"));

            // Set Collider for the Bottom of the Player
            ColliderOrigin.X = location.X + 0.5f * texture.Width;
            ColliderOrigin.Y = location.Y + 0.75f * texture.Height;
            // Add collider to list
            _colliders.Add(new RectCollider(ColliderOrigin, texture.Width, texture.Height / 2, "GoldB"));
