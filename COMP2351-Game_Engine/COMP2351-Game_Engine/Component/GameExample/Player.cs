...
namespace COMP2351_Game_Engine
{
    class Player : RelicHunterEntity, IPlayer, ICollisionListener
    {
        ...
        public override void SetCollider(Vector2 pOrigin, float pWidth, float pHeight)
        {
            Vector2 ColliderOrigin;
            ColliderOrigin.X = location.X + 0.5f * texture.Width;
            ColliderOrigin.Y = location.Y - 0.5f * texture.Height;
            _collider = new RectCollider(ColliderOrigin, texture.Width, texture.Height);
            hasCollider = true;
        }
        ...
        public override void Update()
        {
            ...
            if (_mind != null)
            {
                ...
                _collider.Translate(_mind.TranslateX(), _mind.TranslateY());
            }
